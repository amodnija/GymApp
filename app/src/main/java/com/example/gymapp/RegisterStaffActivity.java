...
public class RegisterStaffActivity extends AppCompatActivity /*implements View.OnClickListener*/ {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        staffbtn = findViewById(R.id.addstaffbtn);
                    ...
                    FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(RegisterStaffActivity.this, DummyActivity.class));
